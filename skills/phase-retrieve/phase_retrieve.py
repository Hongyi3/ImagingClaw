...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--demo", action="store_true", help="Run the deterministic phase demo")
    return parser
...
def main() -> None:
    ...
    run_phase_retrieval = _load_phase_workflow()
    output_dir = Path(args.output).resolve()
    reproduction_command = (
        f"python3 skills/phase-retrieve/phase_retrieve.py"
    ...
    print(f"Wrote phase retrieval bundle to {args.output}")
