...
This directory holds small declared run specifications used for smoke validation and examples.

- `specs/ct_fbp_example.yaml` runs the deterministic CT FBP workflow against repository-local
